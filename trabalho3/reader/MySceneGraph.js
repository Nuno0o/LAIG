...
function Primitive(prim){
	...
	if(this.name == "plane"){
		this.dimX = parseFloat(prim.children[0].attributes.getNamedItem("dimX").value);
		this.dimY = parseFloat(prim.children[0].attributes.getNamedItem("dimY").value);
		this.partsX = parseInt(prim.children[0].attributes.getNamedItem("partsX").value);
		this.partsY = parseInt(prim.children[0].attributes.getNamedItem("partsY").value);
